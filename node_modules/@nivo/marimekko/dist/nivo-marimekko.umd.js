(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@nivo/core'), require('@nivo/axes'), require('@nivo/legends'), require('lodash/get'), require('d3-shape'), require('d3-scale'), require('@nivo/colors'), require('react-spring'), require('@nivo/tooltip')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@nivo/core', '@nivo/axes', '@nivo/legends', 'lodash/get', 'd3-shape', 'd3-scale', '@nivo/colors', 'react-spring', '@nivo/tooltip'], factory) :
  (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.nivo, global.nivo, global.nivo, global['lodash/get'], global.d3, global.d3, global.nivo, global['react-spring'], global.nivo));
}(this, (function (exports, React, core, axes, legends, _get, d3Shape, d3Scale, colors, reactSpring, tooltip) { 'use strict';
  ...
  var offsetById = {
    ...
    silouhette: d3Shape.stackOffsetSilhouette,
  ...
  var useStack = function useStack(dimensionIds, dimensions, offset) {
    return React.useMemo(function () {
      ...
      return d3Shape.stack().keys(dimensionIds).value(function (datum, key) {
  ...
  var useDimensionsScale = function useDimensionsScale(min, max, width, height, layout) {
    return React.useMemo(function () {
      if (layout === 'vertical') {
        return d3Scale.scaleLinear().domain([max, min]).range([0, height]);
      }

      return d3Scale.scaleLinear().domain([min, max]).range([0, width]);
  ...
  var useThicknessScale = function useThicknessScale(_ref) {
    ...
    return React.useMemo(function () {
      ...
      var thicknessScale = d3Scale.scaleLinear().domain([0, totalValue]);
  ...
  var Bar = function Bar(_ref) {
    ...
    var showTooltip = React.useCallback(function (event) {
      return showTooltipFromEvent(React.createElement(tooltip$1, {
        bar: bar
      }), event);
    }, [showTooltipFromEvent, tooltip$1, bar]);
    ...
    return React__default.createElement(reactSpring.animated.rect, {
      x: animatedProps.x,
      y: animatedProps.y,
      width: reactSpring.to(animatedProps.width, function (value) {
        return Math.max(value, 0);
      }),
      height: reactSpring.to(animatedProps.height, function (value) {
        return Math.max(value, 0);
      }),
  ...
  var Bars = function Bars(_ref) {
    ...
    var transition = reactSpring.useTransition(bars, {
    ...
    return React__default.createElement(React__default.Fragment, null, transition(function (style, bar) {
  ...
  var InnerMarimekko = function InnerMarimekko(_ref) {
    var data = _ref.data,
        ...
        legends$1 = _ref$legends === void 0 ? [] : _ref$legends,
        role = _ref.role;
    ...
    if (layers.includes('bars')) {
      layerById.bars = React__default.createElement(Bars, {
        key: "bars",
        bars: bars,
        isInteractive: isInteractive,
        tooltip: tooltip,
    ...
    if (layers.includes('grid')) {
      layerById.grid = React__default.createElement(axes.Grid, {
        key: "grid",
    ...
    if (layers.includes('axes')) {
      layerById.axes = React__default.createElement(axes.Axes, {
        key: "axes",
        xScale: xScale,
        yScale: yScale,
        width: innerWidth,
    ...
    if (layers.includes('legends')) {
      layerById.legends = React__default.createElement("g", {
        key: "legends"
  ...
  var Marimekko = function Marimekko(_ref2) {
    ...
    }, React__default.createElement(InnerMarimekko, Object.assign({
      isInteractive: isInteractive,
      animate: animate,
      motionConfig: motionConfig
    }, otherProps)));
  ...
  var ResponsiveMarimekko = function ResponsiveMarimekko(props) {
    return React__default.createElement(core.ResponsiveWrapper, null, function (_ref) {
      var width = _ref.width,
          height = _ref.height;
      return React__default.createElement(Marimekko, Object.assign({
        width: width,
        height: height
      }, props));
    });
  ...
  exports.Marimekko = Marimekko;
  exports.ResponsiveMarimekko = ResponsiveMarimekko;
  exports.defaultProps = defaultProps;
  exports.offsetById = offsetById;
