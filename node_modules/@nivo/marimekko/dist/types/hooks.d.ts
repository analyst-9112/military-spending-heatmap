...
export declare const useNormalizedData: <RawDatum>(data: RawDatum[], id: string | number | DatumPropertyAccessor<RawDatum, import("csstype").AnimationIterationCountProperty>, value: string | number | DatumPropertyAccessor<RawDatum, number>) => NormalizedDatum<RawDatum>[];
...
export declare const useComputedData: <RawDatum>({ data, stacked, dimensionIds, valueFormat, thicknessScale, dimensionsScale, colors, layout, outerPadding, innerPadding, }: {
    ...
    colors: import("@nivo/colors").OrdinalColorScaleConfig<Pick<DimensionDatum<RawDatum>, "x" | "y" | "height" | "width" | "id" | "value" | "datum" | "formattedValue">>;
    layout: Layout;
    outerPadding: number;
    innerPadding: number;
...
export declare const useMarimekko: <RawDatum>({ data, id, value, valueFormat, dimensions: rawDimensions, layout, offset, outerPadding, innerPadding, colors, borderColor, borderWidth, width, height, }: {
    data: RawDatum[];
    id: string | number | DatumPropertyAccessor<RawDatum, import("csstype").AnimationIterationCountProperty>;
    value: string | number | DatumPropertyAccessor<RawDatum, number>;
    valueFormat: string | ((value: number) => string) | undefined;
    dimensions: {
        id: string;
