(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('d3-scale'), require('@nivo/core'), require('@nivo/colors'), require('@nivo/legends'), require('react-spring'), require('d3-shape'), require('@nivo/tooltip'), require('prop-types')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'd3-scale', '@nivo/core', '@nivo/colors', '@nivo/legends', 'react-spring', 'd3-shape', '@nivo/tooltip', 'prop-types'], factory) :
...
}(this, (function (exports, React, d3Scale, core, colors, legends, reactSpring, d3Shape, tooltip, PropTypes) { 'use strict';
