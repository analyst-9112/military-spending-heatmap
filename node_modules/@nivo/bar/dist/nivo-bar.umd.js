(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('react-motion'), require('@nivo/core'), require('@nivo/axes'), require('@nivo/legends'), require('@nivo/recompose'), require('@nivo/scales'), require('d3-scale'), require('d3-shape'), require('lodash/uniqBy'), require('@nivo/colors'), require('prop-types'), require('@nivo/tooltip'), require('@nivo/annotations')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'react-motion', '@nivo/core', '@nivo/axes', '@nivo/legends', '@nivo/recompose', '@nivo/scales', 'd3-scale', 'd3-shape', 'lodash/uniqBy', '@nivo/colors', 'prop-types', '@nivo/tooltip', '@nivo/annotations'], factory) :
  (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.ReactMotion, global.nivo, global.nivo, global.nivo, global.nivo, global.nivo, global.d3, global.d3, global['lodash/uniqBy'], global.nivo, global.PropTypes, global.nivo, global.nivo));
}(this, (function (exports, React, reactMotion, core, axes, legends, recompose, scales, d3Scale, d3Shape, _uniqBy, colors, PropTypes, tooltip, annotations) { 'use strict';
  ...
  var enhance = recompose.compose(recompose.withPropsOnChange(['data', 'color', 'onClick'], function (_ref2) {
    var data = _ref2.data,
        color = _ref2.color,
  ...
  }), recompose.withPropsOnChange(['data', 'color', 'theme', 'tooltip', 'getTooltipLabel', 'tooltipFormat'], function (_ref3) {
    var data = _ref3.data,
        color = _ref3.color,
        theme = _ref3.theme,
  ...
  var Bar$1 = recompose.setDisplayName('Bar')(enhance$1(Bar));
  ...
  var EnhancedBarCanvas = recompose.setDisplayName('BarCanvas')(enhance$1(BarCanvas));
