(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('lodash.partial'), require('react-motion'), require('@nivo/recompose'), require('@nivo/core'), require('@nivo/legends'), require('prop-types'), require('@nivo/colors'), require('lodash.range'), require('@nivo/tooltip')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'lodash.partial', 'react-motion', '@nivo/recompose', '@nivo/core', '@nivo/legends', 'prop-types', '@nivo/colors', 'lodash.range', '@nivo/tooltip'], factory) :
  (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.lodash.partial, global.ReactMotion, global.nivo, global.nivo, global.nivo, global.PropTypes, global.nivo, global.lodash.range, global.nivo));
}(this, (function (exports, React, partial, reactMotion, recompose, core, legends, PropTypes, colors, range, tooltip) { 'use strict';

  var React__default = 'default' in React ? React['default'] : React;
  partial = partial && Object.prototype.hasOwnProperty.call(partial, 'default') ? partial['default'] : partial;
  ...
  var WaffleCell$1 = recompose.pure(WaffleCell);
  ...
  var WaffleCellHtml$1 = recompose.pure(WaffleCellHtml);
  ...
  var commonEnhancers = [core.withDimensions(), core.withTheme(), core.withMotion(), recompose.withPropsOnChange(['colors'], function (_ref) {
    var colors$1 = _ref.colors;
    return {
      getColor: colors.getOrdinalColorScale(colors$1, 'id')
    };
  }), recompose.withPropsOnChange(['borderColor', 'theme'], function (_ref2) {
    var borderColor = _ref2.borderColor,
        theme = _ref2.theme;
    return {
      getBorderColor: colors.getInheritedColorGenerator(borderColor, theme)
    };
  }), recompose.withState('currentCell', 'setCurrentCell', null), recompose.withPropsOnChange(['rows', 'columns', 'total'], function (_ref3) {
    var rows = _ref3.rows,
  ...
  }), recompose.withPropsOnChange(['width', 'height', 'rows', 'columns', 'fillDirection', 'padding'], function (_ref4) {
  ...
  }), recompose.withPropsOnChange(['data', 'unit', 'getColor', 'hiddenIds'], function (_ref5) {
    var data = _ref5.data,
        unit = _ref5.unit,
  ...
  }), recompose.withPropsOnChange(['computedData'], function (_ref6) {
  ...
  var enhance = (function (Component) {
    ...
    switch (Component.displayName) {
      case 'Waffle':
        return recompose.compose.apply(void 0, [recompose.defaultProps(implDefaultProps)].concat(commonEnhancers, [core.withMotion(), recompose.withPropsOnChange(['computedData', 'defs', 'fill'], function (_ref7) {
        ...
        }), recompose.pure]))(Component);
      case 'WaffleHtml':
        return recompose.compose.apply(void 0, [recompose.defaultProps(implDefaultProps)].concat(commonEnhancers, [core.withMotion(), recompose.pure]))(Component);
      case 'WaffleCanvas':
        return recompose.compose.apply(void 0, [recompose.defaultProps(implDefaultProps)].concat(commonEnhancers, [recompose.pure]))(Component);
    }
    return Component;
  });
  ...
  var Waffle$1 = recompose.setDisplayName(Waffle.displayName)(enhance(Waffle));
  ...
  var WaffleHtml$1 = recompose.setDisplayName(WaffleHtml.displayName)(enhance(WaffleHtml));
  ...
  var WaffleCanvas$1 = recompose.setDisplayName(WaffleCanvas.displayName)(enhance(WaffleCanvas));
