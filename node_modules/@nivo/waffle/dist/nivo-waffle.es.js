...
import { pure, compose, defaultProps, withPropsOnChange, withState, setDisplayName } from '@nivo/recompose';
import { defsPropTypes, noop, withMotion, bindDefs, withDimensions, withTheme, LegacyContainer, SvgWrapper, ResponsiveWrapper, getRelativeCursor, isCursorInRect } from '@nivo/core';
...
var commonEnhancers = [withDimensions(), withTheme(), withMotion(), withPropsOnChange(['colors'], function (_ref) {
...
var enhance = (function (Component) {
  ...
  switch (Component.displayName) {
    case 'Waffle':
      return compose.apply(void 0, [defaultProps(implDefaultProps)].concat(commonEnhancers, [withMotion(), withPropsOnChange(['computedData', 'defs', 'fill'], function (_ref7) {
        var computedData = _ref7.computedData,
            defs = _ref7.defs,
            fill = _ref7.fill;
        return {
          defs: bindDefs(defs, computedData, fill, {
            targetKey: 'fill'
          })
        };
      }), pure]))(Component);
...
var Waffle = function (_Component) {
  ...
  function Waffle() {
    ...
    _this.handleCellHover = function (showTooltip, cell, event) {
      ...
      setCurrentCell(cell);
      if (!cell.data) return;
      showTooltip(React.createElement(WaffleCellTooltip, {
    ...
    value: function render() {
      ...
      return React.createElement(LegacyContainer, {
        ...
        if (animate === true) {
          ...
          cellsRender = React.createElement(TransitionMotion, {
            ...
            return React.createElement(Fragment, null, computedCells.map(function (cell) {
          ...
          cellsRender = React.createElement(Fragment, null, computedCells.map(function (cell) {
            return React.createElement(cellComponent, {
              key: cell.position,
              position: cell.position,
              size: cellSize,
...
var ResponsiveWaffle = function ResponsiveWaffle(props) {
  return React.createElement(ResponsiveWrapper, null, function (_ref) {
    var width = _ref.width,
        height = _ref.height;
    return React.createElement(Waffle$1, Object.assign({
      width: width,
      height: height
    }, props));
  });
...
var ResponsiveWaffleHtml = function ResponsiveWaffleHtml(props) {
  return React.createElement(ResponsiveWrapper, null, function (_ref) {
    var width = _ref.width,
        height = _ref.height;
    return React.createElement(WaffleHtml$1, Object.assign({
      width: width,
      height: height
    }, props));
  });
...
var findCellUnderCursor = function findCellUnderCursor(cells, cellSize, origin, margin, x, y) {
  return cells.find(function (cell) {
    return isCursorInRect(cell.x + origin.x + margin.left, cell.y + origin.y + margin.top, cellSize, cellSize, x, y);
  });
};
...
var ResponsiveWaffleCanvas = function ResponsiveWaffleCanvas(props) {
  return React.createElement(ResponsiveWrapper, null, function (_ref) {
    var width = _ref.width,
        height = _ref.height;
    return React.createElement(WaffleCanvas$1, Object.assign({
      width: width,
      height: height
    }, props));
  });
...
export { ResponsiveWaffle, ResponsiveWaffleCanvas, ResponsiveWaffleHtml, Waffle$1 as Waffle, WaffleCanvas$1 as WaffleCanvas, WaffleCanvasDefaultProps, WaffleCanvasPropTypes, WaffleDefaultProps, WaffleHtml$1 as WaffleHtml, WaffleHtmlDefaultProps, WaffleHtmlPropTypes, WafflePropTypes };
