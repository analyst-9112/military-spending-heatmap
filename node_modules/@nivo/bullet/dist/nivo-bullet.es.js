...
import { animated, to, useTransition, useSpring } from 'react-spring';
...
var BulletMarkers = function BulletMarkers(_ref2) {
  ...
  return React.createElement(React.Fragment, null, transition(function (props, _ref5) {
    ...
    return React.createElement(component, _objectSpread2(_objectSpread2(_objectSpread2({
      key: marker.index
    }, marker), position), {}, {
      animatedProps: props,
      data: marker,
...
var useEnhancedData = function useEnhancedData(data, _ref) {
  ...
  return useMemo(function () {
    return data.map(function (d) {
      ...
      var scale = scaleLinear().domain([min, max]);
