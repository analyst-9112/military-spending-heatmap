(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@nivo/core'), require('@nivo/colors'), require('@nivo/legends'), require('prop-types'), require('@nivo/tooltip'), require('d3-shape'), require('d3-chord'), require('lodash/mapValues'), require('react-motion'), require('@nivo/arcs')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@nivo/core', '@nivo/colors', '@nivo/legends', 'prop-types', '@nivo/tooltip', 'd3-shape', 'd3-chord', 'lodash/mapValues', 'react-motion', '@nivo/arcs'], factory) :
  (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.nivo, global.nivo, global.nivo, global.PropTypes, global.nivo, global.d3, global.d3, global['lodash/mapValues'], global.ReactMotion, global.nivo));
}(this, (function (exports, React, core, colors, legends, PropTypes, tooltip, d3Shape, d3Chord, mapValues, reactMotion, arcs) { 'use strict';

  var React__default = 'default' in React ? React['default'] : React;
  PropTypes = PropTypes && Object.prototype.hasOwnProperty.call(PropTypes, 'default') ? PropTypes['default'] : PropTypes;
  mapValues = mapValues && Object.prototype.hasOwnProperty.call(mapValues, 'default') ? mapValues['default'] : mapValues;
  ...
  var commonPropTypes = {
    ...
    arcBorderColor: colors.inheritedColorPropType.isRequired,
    ...
    ribbonBorderColor: colors.inheritedColorPropType.isRequired,
    ribbonBlendMode: core.blendModePropType.isRequired,
    ...
    return React__default.createElement(reactMotion.TransitionMotion, {
      styles: arcs.map(function (arc) {
        return {
          ...
          }, colors.interpolateColor(arc.color, springConfig))
        };
      })
    }, function (interpolatedStyles) {
  ...
  var Chord = function Chord(_ref) {
    ...
    var getArcBorderColor = colors.useInheritedColor(arcBorderColor, theme);
    var getRibbonBorderColor = colors.useInheritedColor(ribbonBorderColor, theme);
  ...
  var getArcFromMouseEvent = function getArcFromMouseEvent(_ref) {
    ...
    return arcs.findArcUnderCursor(centerX, centerY, radius, innerRadius, arcs$1, x, y);
  };
    ...
    React.useEffect(function () {
      ...
      layers.forEach(function (layer) {
        ...
        if (layer === 'labels' && enableLabel === true) {
          ...
          arcs.forEach(function (arc) {
            var angle = core.midAngle(arc);
            var props = core.getPolarLabelProps(radius + labelOffset, angle, labelRotation);
            ctx.save();
            ctx.translate(props.x, props.y);
            ctx.rotate(core.degreesToRadians(props.rotate));
